        ...
        <div class="uk-grid-match uk-grid-collapse uk-child-width-1-2@m" uk-grid>
          <div class="uk-width-1-3@m">
            <div class="uk-card uk-card-small uk-card-body uk-flex uk-flex-column uk-flex-center">
              <h4 class="uk-card-title uk-margin-remove-bottom">Адрес</h4>
            ...
            <div class="uk-card uk-card-small uk-card-body uk-flex uk-flex-column uk-flex-center uk-background-muted">
              <h4 class="uk-card-title uk-margin-remove-bottom">Телефон</h4>
            ...
            <div class="uk-card uk-card-small uk-card-body uk-flex uk-flex-column uk-flex-center">
              <h4 class="uk-card-title uk-margin-remove-bottom">E-mail</h4>
              <p class="uk-margin-remove-top">
            ...
            <div class="uk-card uk-card-small uk-card-body uk-flex uk-flex-column uk-flex-center uk-background-muted">
              <h4 class="uk-card-title uk-margin-remove-bottom">Сайт компании</h4>
              <p class="uk-margin-remove-top">
                <span class="uk-text-danger" uk-icon="link"></span>&nbsp;
                <a class="uk-link-heading" :href="website" target="_blank">{{ website }}</a>
              </p>
            </div>             
          </div>
...
<script>
  import { mapState } from 'vuex'
	...
	export default {
    computed: {
      ...mapState([ 'address', 'phoneNumber', 'email', 'website' ])
    },
    methods: {
        ...
        (event) => {
          window.addEventListener(
            ...
            (e) => {
              ...
              if (element) {
                element.style.width = window.innerWidth >= 960 ? 'calc(' + (document.documentElement.clientWidth - element.getBoundingClientRect().left) + 'px - 2px)' : ''
